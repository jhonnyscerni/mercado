...
create table edital (id int8 not null, ativo boolean not null, codigo_usuario_criacao int8, codigo_usuario_modificacao int8, criacao timestamp not null, modificacao timestamp, data_fim timestamp, data_inicio timestamp, numero int8 not null, empresa_id int8 not null, endereco_id int8 not null, produto_id int8 not null, primary key (id));
