...
create table edital_item (id int8 not null, ativo boolean not null, codigo_usuario_criacao int8, codigo_usuario_modificacao int8, criacao timestamp not null, modificacao timestamp, altura float8 not null, especificacao varchar(255) not null, largura float8 not null, observacao varchar(255), peso float8 not null, profundidade float8 not null, proposta_parcial boolean, quantidade float8 not null, valor_maximo numeric(19, 2) not null, edital_id int8 not null, produto_id int8 not null, unidade_medida_id int8 not null, primary key (id));
