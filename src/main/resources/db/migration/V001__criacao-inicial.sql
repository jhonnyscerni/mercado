...
create table tb_usuarios (id int8 not null, ativo boolean not null, codigo_usuario_criacao int8, codigo_usuario_modificacao int8, criacao timestamp not null, modificacao timestamp, email varchar(255) not null, password varchar(255) not null, status_usuario varchar(255), telefone varchar(255), tipo_usuario varchar(255), username varchar(255), nome varchar(255), cpf varchar(255) not null, empresa_id int8 not null, primary key (id));
