...
create table categoria_produto (id int8 not null, nome_desc varchar(255) not null, primary key (id));
create table edital (id int8 not null, data_fim timestamp, data_inicio timestamp, numero int8 not null, empresa_id int8 not null, endereco_id int8 not null, produto_id int8 not null, primary key (id));
create table endereco (id int8 not null, bairro varchar(255) not null, cep varchar(255) not null, cidade varchar(255) not null, complemento varchar(255), estado varchar(255), numero varchar(255) not null, rua_logra varchar(255) not null, tipo_endereco varchar(255), primary key (id));
...
create table marca_produto (id int8 not null, nome_desc varchar(255) not null, primary key (id));
...
create table tb_empresas (id int8 not null, categoria varchar(255), cnpj varchar(255) not null, insc_estadual varchar(255) not null, insc_municipal varchar(255), nome_fantasia varchar(50) not null, razao_social varchar(255) not null, telefone varchar(255), endereco_id int8, primary key (id));
create table tb_grupos (id int8 not null, nome varchar(30) not null, primary key (id));
create table tb_usuarios (id int8 not null, email varchar(255) not null, password varchar(255) not null, status_usuario varchar(255), telefone varchar(255), tipo_usuario varchar(255), username varchar(255), empresa_id int8 not null, primary key (id));
